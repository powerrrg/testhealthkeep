...
<div id="main">
	<div class="iHold">
		...
		<div class="iHeading">
				<h1 class="stepsHeading center colorGray">Enter any symptoms you want to follow</h1>
		</div>
		...
		<?php
		$needTokenInput=1;
		$onload.="$('#topic').tokenInput('".WEB_URL."act/ajax/autoCompleteTopic.php?type=s', { hintText: 'Type the name of the symptom', noResultsText: 'No symptom with that name', searchingText: 'Searching...',tokenLimit: 10,minChars: 2,searchDelay: 200,preventDuplicates: true, theme:'long' });";
