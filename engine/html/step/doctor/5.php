...
if(defined(USER_TYPE) || USER_TYPE<5){
	if(isset($_SESSION["mx_signup"]) && $_SESSION["mx_signup"]==5){
		...
		function mx_finish_steps(){
			mixpanel.track_links('Doctor Finished Steps');
			return true;
		}
		";
...
<div id="main">
	<div class="iHold">
		...
		<div class="iHeading">
				<h1 class="stepsHeading center colorGray">Enter any surgeries/procedures you want to follow</h1>
		</div>
		...
		<form action="<?php echo WEB_URL; ?>act/step/save.php?t=d&s=<?php echo $step; ?>" id="steps" method="post" class="addEventForm borderTop">
			<div class="addEventFormItem clearfix">
				<h4>Please enter procedures</h4>
				<div class="addEventFormInputs">
				<input type="text" id="topic" name="topic" />
				</div>
			</div>
			<div class="addEventFormButtons clearfix">
				<input type="submit" class="btn btn-blue" onclick="return mx_finish_steps();" value="Finish" />
			</div>
		</form>
