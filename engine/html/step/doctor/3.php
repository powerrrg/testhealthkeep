...
if(defined(USER_TYPE) || USER_TYPE<5){
	if(isset($_SESSION["mx_signup"]) && $_SESSION["mx_signup"]==3){
		$jsfunctions.="mixpanel.track('Doctor Step $step');";
		$_SESSION["mx_signup"]=4;
	}
}
...
<div id="main">
	<div class="iHold">
		...
		<div class="iHeading">
				<h1 class="stepsHeading center colorGray">Enter any medications you want to follow</h1>
		</div>
		...
		<form action="<?php echo WEB_URL; ?>act/step/save.php?t=d&s=<?php echo $step; ?>" id="steps" method="post" class="addEventForm borderTop">
			<div class="addEventFormItem clearfix">
				<h4>Please enter medications</h4>
