...
if(defined(USER_TYPE) || USER_TYPE<5){
	if(isset($_SESSION["mx_signup"]) && $_SESSION["mx_signup"]==4){
		$jsfunctions.="mixpanel.track('User Step $step');";
		$_SESSION["mx_signup"]=5;
	}
}
...
<div id="main">
	<div class="iHold">
		...
		<div class="iHeading">
				<h1 class="stepsHeading center colorGray">Enter any medications you currently take</h1>
		</div>
		...
		<form action="<?php echo WEB_URL; ?>act/step/save.php?t=u&s=<?php echo $step; ?>" id="steps" method="post" class="addEventForm borderTop">
			<div class="addEventFormItem clearfix">
				<h4>Please enter your medications</h4>
		...
		<?php
		$needTokenInput=1;
		$onload.="$('#topic').tokenInput('".WEB_URL."act/ajax/autoCompleteTopic.php?type=m', { hintText: 'Type the name of the medication', noResultsText: 'No medication with that name', searchingText: 'Searching...',tokenLimit: 10,minChars: 2,searchDelay: 200,preventDuplicates: true, theme:'long' });";
