...
<article id="main">
	<hgroup class="iWrap clearfix">
		<div class="iFull iText">
			<h2 class="iFullHeading">Change your avatar</h2>
			<form id="iMavatarForm" enctype="multipart/form-data" method="post" action="<?php echo WEB_URL; ?>act/profile/avatar.php">
						...
						<button id="saveMyAvatar" type="button" class="btn btn-blue">save</button> <a href="<?php echo WEB_URL.$resProfile[0]["username_profile"]; ?>" class="colorGray">cancel</a>
						<?php
						$onload.="
