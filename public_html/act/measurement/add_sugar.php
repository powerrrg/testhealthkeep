...
if(isset($_POST["sugar"]) && isset($_POST["month"]) && isset($_POST["day"]) && isset($_POST["year"])){
	
	if(!is_numeric($_POST["sugar"])){
		go404();
	}
	$weight=(int)$_POST["sugar"];
	...
	$res=$timelineClass->addMeasurement("sugar",$weight,$date_tm);
